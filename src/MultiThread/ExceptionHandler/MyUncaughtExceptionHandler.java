package MultiThread.ExceptionHandler;
...
public class MyUncaughtExceptionHandler {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("default handler main " + Thread.currentThread().getUncaughtExceptionHandler());
    ...
    public static class TestedThread extends Thread {
        ...
        public void run() {
            ...
            System.out.println("handler run() " + Thread.currentThread().getUncaughtExceptionHandler());
            try {
                Thread.sleep(3000);
